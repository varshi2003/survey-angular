...
//     return this.http.get<SurveyResponse>(`${this.baseUrl}/survey-responses/${responseId}`);
//   }

//   getSurveyStatus(surveyId: string, responseId: string): Observable<string> {
//     return this.http.get(`${this.baseUrl}/result-dashboard/status/${surveyId}/${responseId}`, { responseType: 'text' });
//   }

//   acceptSurvey(surveyId: string, responseId: string): Observable<void> {
//     return this.http.post<void>(`${this.baseUrl}/result-dashboard/accept`, { surveyId, surveyResponseId: responseId });
//   }

//   rejectSurvey(surveyId: string, responseId: string): Observable<void> {
//     return this.http.post<void>(`${this.baseUrl}/result-dashboard/reject`, { surveyId, surveyResponseId: responseId });
//   }
// }
...
//   getSurveyResponse(responseId: string): Observable<Survey> {
//     return this.http.get<Survey>(`${this.baseUrl}/survey-responses/${responseId}`);
//   }
